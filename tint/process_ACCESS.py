...
def format_ACCESS_C(datetime, reference_grid, gadi=False):
    ...
    radar_refl_1km = xr.open_dataset(
        base_dir + date + '/1200/fcmm/sfc/radar_refl_1km.nc')['radar_refl_1km']

    # We are taking the +12 forecast at 12:00 UTC on the previous day
    start = datetime
    end = datetime + np.timedelta64(1, 'D')
